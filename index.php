...
QUER RESETAR O SEU METABOLISMO?
HEADLINE_END;
...
$text Questão 3 de 4 
\n Você já experimentou dietas rígidas e lutou para perder peso no passado?
QUESTION3_END;
...
$text Questão 4 de 4 
\n Você tem 30 anos ou mais e quer perder 5 quilos ou mais de forma rápida e segura?
QUESTION4_END;
...
# Question 5 
$question[5] = <<< QUESTION5_END
QUESTION5_END;
$answer_type[5] = "Checkboxes"; // "Buttons" or "Checkboxes" allowed
// Specify the question answers below, one answer per line
$answers[5] = <<< QUESTIONANSWERS5_END
QUESTIONANSWERS5_END;

# Question 6 
$question[6] = <<< QUESTION6_END
QUESTION6_END;
$answer_type[6] = "Buttons"; // "Buttons" or "Checkboxes" allowed
// Specify the question answers below, one answer per line
$answers[6] = <<< QUESTIONANSWERS6_END
Yes
No
QUESTIONANSWERS6_END;

# Question 7 
$question[7] = <<< QUESTION7_END
QUESTION7_END;
$answer_type[7] = "Buttons"; // "Buttons" or "Checkboxes" allowed
// Specify the question answers below, one answer per line
$answers[7] = <<< QUESTIONANSWERS7_END
Yes
No
QUESTIONANSWERS7_END;

# Question 8 
$question[8] = <<< QUESTION8_END
QUESTION8_END;
$answer_type[8] = "Buttons"; // "Buttons" or "Checkboxes" allowed
// Specify the question answers below, one answer per line
$answers[8] = <<< QUESTIONANSWERS8_END
Yes
No
QUESTIONANSWERS8_END;

# Question 9 
$question[9] = <<< QUESTION9_END
QUESTION9_END;
$answer_type[9] = "Buttons"; // "Buttons" or "Checkboxes" allowed
// Specify the question answers below, one answer per line
$answers[9] = <<< QUESTIONANSWERS9_END
Yes
No
QUESTIONANSWERS9_END;

# Question 10 
$question[10] = <<< QUESTION10_END
QUESTION10_END;
$answer_type[10] = "Buttons"; // "Buttons" or "Checkboxes" allowed
// Specify the question answers below, one answer per line
$answers[10] = <<< QUESTIONANSWERS10_END
Yes
No
QUESTIONANSWERS10_END;

# Smart Match System Titles and Text
# Smart Match Lead In (Before Question Validations)
$smartMatchTitle[0] = <<< SMARTMATCHTITLE0_END
Verificando nosso Sistema Inteligente de Correspondência<sup>TM</sup>
SMARTMATCHTITLE0_END;

$smartMatchText[0] = <<< SMARTMATCHTEXT0_END
Obrigado. Estamos avaliando suas respostas.
SMARTMATCHTEXT0_END;

# Smart Match 1
$smartMatchTitle[1] = <<< SMARTMATCHTITLE1_END
Questão 1: Processando..
...
Questão 4: Processando..
SMARTMATCHTITLE4_END;

$smartMatchText[4] = <<< SMARTMATCHTEXT4_END
<h4>Parabéns! <span style="color:#021f38;">Você está aprovado(a) para ver a apresentação.</span></h4>
SMARTMATCHTEXT4_END;

# Smart Match 5
$smartMatchTitle[5] = <<< SMARTMATCHTITLE5_END
SMARTMATCHTITLE5_END;

$smartMatchText[5] = <<< SMARTMATCHTEXT5_END
Por favor, leia nossas 3 regras agora!
SMARTMATCHTEXT5_END;

# Smart Match 6
$smartMatchTitle[6] = <<< SMARTMATCHTITLE6_END
SMARTMATCHTITLE6_END;

$smartMatchText[6] = <<< SMARTMATCHTEXT6_END
SMARTMATCHTEXT6_END;

# Smart Match 7
$smartMatchTitle[7] = <<< SMARTMATCHTITLE7_END
SMARTMATCHTITLE7_END;

$smartMatchText[7] = <<< SMARTMATCHTEXT7_END
SMARTMATCHTEXT7_END;

# Smart Match 8
$smartMatchTitle[8] = <<< SMARTMATCHTITLE8_END
SMARTMATCHTITLE8_END;

$smartMatchText[8] = <<< SMARTMATCHTEXT8_END
SMARTMATCHTEXT8_END;

# Smart Match 9
$smartMatchTitle[9] = <<< SMARTMATCHTITLE9_END
SMARTMATCHTITLE9_END;

$smartMatchText[9] = <<< SMARTMATCHTEXT9_END
SMARTMATCHTEXT9_END;

# Smart Match 10
$smartMatchTitle[10] = <<< SMARTMATCHTITLE10_END
SMARTMATCHTITLE10_END;

$smartMatchText[10] = <<< SMARTMATCHTEXT10_END
SMARTMATCHTEXT10_END;
...
<?php echo $sSMSTextHTML; ?>
			...
			<article id="surveyEnd2">
				...
				<section>
					<div style="color:#FFFFFF;font-size:16px;text-align:left;">
						...
						<p id="ifyouagree" style="padding-left:60px;color:#000000;">Se você concordar com todos os itens acima, clique no botão "Concordo" abaixo para prosseguir para a seguinte apresentação privada.</p>
					</div>
				</section>
			                                                           <button id="surveyAgree" data-tracking-suffix="<?php echo $buttonClickTrackingSuffix; ?>" class="stepButton yesBtn" onclick="<?php echo $onclick; ?>">CONCORDO - MOSTRE-ME O VÍDEO!</button>
			</article>
		</div>
	</div>
</div>
	...
	<div id="footer">
		...
		<p style="text-align: center;">&copy; <script type="text/javascript">var cur = 2019; var year = new Date(); if(cur == year.getFullYear()) year = year.getFullYear(); else year = cur + ' - ' + year.getFullYear(); document.write(year);</script> <span style="font-size: x-small;"><a href="politica-de-privacidade.html">Politica de privacidade</a> | <a href="termos-de-uso.html">Termos de uso</a>
		<?php echo $disclaimer; ?>
		</div>
	</div>
</div>
